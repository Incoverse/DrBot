...
"[project]/src/controllers/dashboard/app/lib/channel.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ /** Cookie holding the dashboard's currently-active broadcaster twitch id. */ __turbopack_context__.s([
    "ACTIVE_CHANNEL_COOKIE",
    ()=>ACTIVE_CHANNEL_COOKIE
]);
const ACTIVE_CHANNEL_COOKIE = "dash_active_channel";
}),
"[project]/src/controllers/dashboard/app/app/api/me/channels/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controllers$2f$dashboard$2f$app$2f$lib$2f$channel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/controllers/dashboard/app/lib/channel.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    ...
    const streamers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controllers$2f$dashboard$2f$app$2f$lib$2f$waiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStreamers"])();
    ...
    const cookieId = req.cookies.get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controllers$2f$dashboard$2f$app$2f$lib$2f$channel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ACTIVE_CHANNEL_COOKIE"])?.value ?? null;
    const activeChannelId = cookieId && channels.some((c)=>c.id === cookieId) && cookieId || channels.some((c)=>c.id === session.twitchId) && session.twitchId || (channels[0]?.id ?? null);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1qqtrfo._.js.map