...
"[project]/src/controllers/dashboard/app/app/api/commands/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controllers$2f$dashboard$2f$app$2f$lib$2f$waiter$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCommandHandler"])();
    if (!handler) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Command handler not ready"
    }, {
        status: 503
    });
...
async function PATCH(req) {
    ...
    if (!channelId || !id || typeof enabled !== "boolean") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "channel, id and boolean enabled required"
        }, {
            status: 400
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__112-02r._.js.map